...
function getRandomInt(max) { // Returns a random Integer in the rang 0, ..., max-1
...
function progressBarFrame() {
    if (progressBarWidthNumerator <= 0) {
        ...
        const currentProgressBarWidth = progressBarWidthNumerator/
        progressBarWidthDenominator;
